...
* 2. Slide Deck (https://docs.google.com/presentation/d/1gT7fIRh8qiDTqAfgocJQ7a2nDc8e3OpF81UuBugR2FQ/edit?usp=drivesdk): *( — `swallowcode_short_story.pptx` and `swallowcode_short_story.pdf` are in this repo)*
* 3. YouTube Video Link-1: https://youtu.be/Nvqn2yglE4s
* 4. Youtube Video Link-2: https://youtu.be/IemqzZLCM44
